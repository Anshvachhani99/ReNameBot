...
│
├<b>💢 Source : <a href='https://t.me/TmkocEpisodeV3'>Click Here</a></b>
│
...
╰──────[Thanks 😊]───⍟"""
    ...
    UPLOAD_SUCCESS = "<u><i>Tʜᴀɴᴋs Fᴏʀ Usɪɴɢ ᴍᴇ❤ Join @TmkocEpisodeV3</i></u>"
    ...
    CONTACT_MY_DEVELOPER = "<i>Something Went Wrong! Contact in Support Group chat @AakankshaV2bot for Help. </i>"
    START_TEXT = "<i>This is a Fastest File Renamer and Converter Bot With Permanant Thumbnail Support💯</i>"
    UPGRADE_TEXT = "<b>To upgrade your subscription <a href='https://t.me/AakankshaV2bot>[Click Here]</a></b>"
